...
<body>
	...
	<h4>표현식으로 출력</h4>
	<p>
		num1 : <%= num1 %><br>  <!-- 표현식 % out.print(num1) %과 동일 -->
		num2 : <%= num2 %><br>
		str1 : <%= str1 %><br>
		str2 : <%= str2 %><br>
		str3 : <%= str3 %><br>
	...
	<h4>표현언어</h4>
		<p>
			...
			str2 : ${str2}<br>
			str3 : ${str3}<br>
			str4 : ${str4}<br> <!-- 표현언어는 null값 출력 안됨 -->
		</p>
	
	<h4>표현언어 내장객체</h4>
		<p>
			num1 : ${pageScope.num1}<br> <!--위와 동일하나 앞에 pageScope.내장객체 생략 되어있음 -->
			num2 : ${requestScope.num2}<br>
			str1 : ${sessionScope.str1}<br>
			str2 : ${applicationScope.str2}<br>
			str3 : ${requestScope.str3}<br>
			str4 : ${requestScope.str4}<br> <!-- 표현언어는 null값 출력 안됨 -->
		</p>
	<h4>표현언어 연산자</h4>
		<p>
