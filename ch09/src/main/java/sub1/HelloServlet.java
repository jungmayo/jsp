...
public class HelloServlet extends HttpServlet { //서블릿을 요청할 수 있는 주소가 있어야함 -> 액션 (web.xml에)
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 클라이언트의 요청이 POST일 경우 호출됨
		System.out.println("HelloServlet doPost...");
	}
	@Override
	public void destroy() {
		// init의 반대, 서블릿이 종료될 때 , 서버가 종료될 때
